...
const externalContracts = {
  8453: {
    BuidlGuidlBread: {
      address: "0xE20a0e016c84C9683B5F258f3ECCb0B365ffB8Fa", // Replace with actual address
      abi: [
          {
            inputs: [
          ...
          { inputs: [], name: "BatchMintAmountExceedsLimit", type: "error" },
          { inputs: [], name: "BatchMintCooldownNotExpired", type: "error" },
          { inputs: [], name: "BatchMintLimitCannotBeZero", type: "error" },
          { inputs: [], name: "BatchMintingPeriodCompletionPaused", type: "error" },
          { inputs: [], name: "BatchSizeTooLarge", type: "error" },
          { inputs: [], name: "CannotMintToZeroAddress", type: "error" },
          { inputs: [], name: "CannotMintWhilePaused", type: "error" },
          { inputs: [], name: "CannotMintZeroAmount", type: "error" },
          { inputs: [], name: "CannotSetZeroAddress", type: "error" },
          {
            inputs: [
          ...
          { inputs: [], name: "NoBatchMintingOccurredThisPeriod", type: "error" },
          {
          ...
          { inputs: [], name: "OwnerMintAmountExceedsLimit", type: "error" },
          { inputs: [], name: "OwnerMintCooldownNotExpired", type: "error" },
          { inputs: [], name: "UnauthorizedBatchMinter", type: "error" },
